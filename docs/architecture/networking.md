...
The single source of truth is [网络契约](../../.agents/skills/orbit-feature-development/references/network-contract.md). API, DTO, HTTP errors, OIDC headers, SSE and asynchronous task creation must follow it.
